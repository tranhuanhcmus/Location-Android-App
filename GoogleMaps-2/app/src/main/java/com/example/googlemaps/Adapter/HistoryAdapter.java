...
public class HistoryAdapter extends ArrayAdapter<InfoSearching> {
    Context context;
    List<InfoSearching> listPrediction;

    public HistoryAdapter(@NonNull Context context, @NonNull List<InfoSearching> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        if(convertView == null){
            convertView = LayoutInflater.from(this.context).inflate(R.layout.list_item_history,parent,false);
        }
